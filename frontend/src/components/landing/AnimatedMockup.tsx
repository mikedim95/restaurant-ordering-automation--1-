...
export const AnimatedMockup = () => {
  ...
  return (
    <div className="py-24 bg-gradient-to-br from-blue-50 to-purple-50 overflow-hidden">
            ...
            {steps.map((step, idx) => (
              <div
                ...
                className={`flex items-center gap-4 p-4 rounded-lg transition-all ${
                  idx === currentStep
                    ? 'bg-purple-100 border-2 border-purple-500 md:scale-105 ring-1 ring-purple-400'
          ...
          <div className="relative overflow-hidden">
            <div className="flex gap-8 justify-center overflow-x-hidden">
              <div className="relative">
                <Smartphone className="h-56 w-28 md:h-64 md:w-32 text-gray-300 max-w-full" strokeWidth={1} />
                <div className="absolute inset-2 bg-gradient-to-br from-purple-400 to-blue-400 rounded-lg opacity-80" />
              </div>
              <div className="relative">
                <Monitor className="h-40 w-56 md:h-48 md:w-64 text-gray-300 max-w-full" strokeWidth={1} />
